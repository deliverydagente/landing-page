        ...
        <div className={styles.BoxResponsive}>
          {auxData.isSuccedRequest === true ? (
            <div className={styles.BoxSuccedToConfirm}>
              ...
              <h1>Exelente!</h1>
              <h3>
                Enviamos um <b>E-mail</b> para <b>{placeState.email}</b>, siga
                as instruções para finalizar o processo.{" "}
              </h3>
            </div>
          ) : (
            <>
              ...
              <div className={styles.BoxSubTitle}>
                Estamos analisando todos os perfis para liberação das vendas no
                App. Entre em contato e respondemos o mais rápido possível!
              </div>
              <div className={styles.BoxInput}>
                ...
                <InputTextField
                  ...
                  onChangeValue={(value) => setPlaceState({ name: value })}
                ...
                <InputTextField
                  ...
                  onChangeValue={(value) => setPlaceState({ email: value })}
                  placeholder="example@example.com"
                />
                <LabelInfoField classNames={styles.LabelInfoStoreName}>
                  Não iremos compartilhar essa informação com mais ninguém.
                </LabelInfoField>
                <LabelField
                ...
                <InputTextField
                  ...
                  onChangeValue={(value) => setPlaceState({ instagram: value })}
                ...
                <LabelInfoField>
                  <>
                    Ao continuar você está concordando com os{" "}
